...
|---|---|---|---|---|---|---|---|---|
| prompt_only | 1.00 | 0.01 | 0.00 | 0.00 | 0.00 | 0.03 | 0.00 | 0.00 |
| prompt_plus_image | 1.00 | 0.21 | 0.39 | 0.00 | 0.27 | 0.18 | 0.03 | 0.00 |
| prompt_plus_sparse_video | 0.99 | 0.33 | 0.22 | 0.00 | 0.11 | 0.37 | 0.04 | 0.00 |
| tool_allowlist_only | 0.00 | 0.00 | 0.01 | 0.00 | 0.00 | 0.00 | 0.00 | 0.22 |
| **lattice_mg** | 1.00 | 0.97 | 0.98 | 0.98 | 0.94 | 0.93 | 0.90 | 1.00 |

Attack success rate / benign preservation rate:

| defense | attack success rate | benign preservation rate |
|---|---|---|
| prompt_only | 0.87 | 0.90 |
| prompt_plus_image | 0.74 | 0.94 |
| prompt_plus_sparse_video | 0.74 | 0.96 |
| tool_allowlist_only | 0.97 | 1.00 |
| **lattice_mg** | **0.04** | **1.00** |
