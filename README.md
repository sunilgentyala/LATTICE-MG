...
|---|---|---|
| prompt filter only | 0.87 | 0.90 |
| prompt + image output classifier | 0.74 | 0.94 |
| prompt + sparse video sampling | 0.74 | 0.96 |
| tool allowlist only | 0.97 | 1.00 |
| **LATTICE-MG** | **0.04** | **1.00** |
